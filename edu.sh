...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/vpnerror404/scbiasa/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/vpnerror404/scbiasa/main/edu-op.py
