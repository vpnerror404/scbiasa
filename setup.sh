...
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
wget http://raw.githubusercontent.com/vpnerror404/scbiasa/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install xray
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/install-xray.sh && chmod +x install-xray.sh && screen -S xray ./install-xray.sh

#install L2TP
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/vpnerror404/scbiasa/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/vpnerror404/scbiasa/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
